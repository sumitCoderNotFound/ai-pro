    ...
    <div className="p-6 lg:p-8">
      ...
      <div className="grid sm:grid-cols-2 lg:grid-cols-4 gap-6 mb-8">
        <div className="bg-white rounded-2xl border border-neutral-200 p-6">
          ...
          <div className="text-3xl font-bold text-neutral-900">{stats.total_campaigns}</div>
        </div>
        ...
        <div className="bg-white rounded-2xl border border-neutral-200 p-6">
          ...
          <div className="text-3xl font-bold text-neutral-900">{stats.active_campaigns}</div>
        </div>
        ...
        <div className="bg-white rounded-2xl border border-neutral-200 p-6">
          ...
          <div className="text-3xl font-bold text-neutral-900">{stats.total_calls.toLocaleString()}</div>
        </div>
        ...
        <div className="bg-white rounded-2xl border border-neutral-200 p-6">
          ...
          <div className="text-3xl font-bold text-neutral-900">{stats.success_rate}%</div>
        </div>
      </div>
