  ...
  theme: {
    extend: {
      ...
      backgroundImage: {
        ...
        'mesh-gradient': 'radial-gradient(at 40% 20%, hsla(240, 70%, 50%, 0.3) 0px, transparent 50%), radial-gradient(at 80% 0%, hsla(189, 100%, 56%, 0.2) 0px, transparent 50%), radial-gradient(at 0% 50%, hsla(355, 85%, 50%, 0.1) 0px, transparent 50%)',
      },
    },
  },
  plugins: [],
